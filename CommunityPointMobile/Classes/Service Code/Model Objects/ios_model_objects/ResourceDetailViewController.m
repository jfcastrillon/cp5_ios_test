		...
		for (CPMService* service in [[displayedResource services] objectForKey:@"primary"]) {
			...
			if (![[service code] hasPrefix:@"Y"]) {
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails applicationProcess];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails areaFlexible];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails availability];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails availableForDirectory];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails availableForReferral];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails availableForResearch];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails capacity];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails description];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails eligibilityRequirements];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails feeStructure];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails hours];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails languages];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails notes];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails requiredDocuments];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails resourceContact];
				...
				if (currentIndex == row) {
					...
					cell.textLabel.text = [serviceDetails serviceArea];
